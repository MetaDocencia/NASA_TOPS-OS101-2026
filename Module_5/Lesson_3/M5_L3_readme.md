...
"Reproducibility is a researcher's ability to obtain the same results in a published article using the raw data and code used in the original study. (Stodden, 2015)"
...
<table>
  ...
  <tbody>
    <tr>
        <td colspan="4">
            <p>Blogs are long-form articles that aren't peer-reviewed. Blogs can be a great way to share your scientific process and findings before they are published, but they can also provide another presentation of the material even after they are published. For example, maybe you write a scientific article on your research that is highly technical, but then break it down in a more understandable language in a blog post. Many scientists use blog posts to develop and test ideas and approaches because they are more interactive. There are science blogs all over the internet. Some popular ones are <a href="https://medium.com/tag/science">Medium</a> (external link), <a href="https://sciencebites.org/sciencebites-sites-galaxy/">Science Bites</a> (external link), and <a href="https://blogs.scientificamerican.com/">Scientific American</a> (external link). One good way to get started is to find a blog post that you like or find inspirational and use it as a guide for writing your own post.</p>
        </td>
    </tr>
  </tbody>
</table>
...
Image credit: "A map of the EHT. Stations active in 2017 and 2018 are shown with connecting lines and labeled in yellow, sites in commission are labeled in green, and legacy sites are labeled in red. From Paper II (Figure 1)" by The Astrophysical Journal Letters is licensed under CC-BY 4.0.
...
For additional tips on how to acknowledge different kinds of contributors or develop a resource including authorship, check out [Acknowledging Contributors The Turing Way](https://the-turing-way.netlify.app/community-handbook/acknowledgement.html) (external link).

If working with online repositories such as GitHub, an app like the '[all-contributors](https://allcontributors.org/)' (external link) bot is a great way to automate capturing all kinds of contributions, from fixing bugs to organizing events to improving usability in the project.

More systematic work is being undertaken by [hidden REF](https://hidden-ref.org/) (external link), who constructed a broad set of [categories](https://hidden-ref.org/categories) (external link) that can be used for celebrating everyone who contributes to the research.

There are several [infrastructure roles](https://the-turing-way.netlify.app/collaboration/research-infrastructure-roles.html) (external link) such as community managers, data stewards, product managers, ethicists, and science communicators that are also being recognized as valued members in research projects. There is also an intention to provide leadership paths for technical and subject matter experts, even when their contributions can't always be assessed in tangible or traditional outputs. (Mazumdar et al., 2015; Bennett et al., 2023)

[The Declaration on Research Assessment](https://sfdora.org/) (DORA) (external link) is also a good resource to understand what researchers, institutions, funders and publishers can do to improve the ways in which researchers and the outputs of scholarly research are evaluated.
...
The polarized image of the M87 black hole shadow as observed on April 11, 2017 by the EHT (left panel), an image from the EHT Model Library with a MAD magnetic configuration (right panel), and a list of papers describing different sets of results. [Screenshot]. (2023). IOPscience. [https://iopscience.iop.org/journal/2041-8205/page/Focus_on_EHT](https://iopscience.iop.org/journal/2041-8205/page/Focus_on_EHT) (external link)

---

Across [several preprints](https://arxiv.org/search/astro-ph?searchtype=author&query=Event%2BHorizon%2BTelescope%2BCollaboration) (external link) and [eight peer-reviewed letters](https://iopscience.iop.org/journal/2041-8205/page/Focus_on_EHT) (external link), EHTC presented open results issued from different teams on instrumentation, observation, algorithm, software, modeling, and data management, providing the full scope of the project and the conclusions drawn to date.
...
- A. Open access papers
- B. Conference presentation
- C. Internal team meeting notes 
- D. Regular reports shared online
- E. Poster at a workshop
- F. Blog post
- G. Computational notebook on GitHub
- H. Figure with a DOI (e.g, Zenodo or Figshare)
- I. Pre-print of a paper
...
- Bennett, A., Garside, D., Praag, C. G. van, Hostler, T. J., Garcia, I. K., Plomp, E., Schettino, A., Teplitzky, S., & Ye, H. (2023). A Manifesto for Rewarding and Recognizing Team Infrastructure Roles. Journal of Trial & Error, 4(1). [https://doi.org/10.36850/mr8](https://doi.org/10.36850/mr8) (external link)
- CRediT (Contribution Roles Taxonomy). (2025). Wiley Author Services. [https://authorservices.wiley.com/author-resources/Journal-Authors/open-access/credit.html](https://authorservices.wiley.com/author-resources/Journal-Authors/open-access/credit.html) (external link)
...
- Stodden, V. (2015). Reproducing Statistical Results. Annual Review of Statistics and Its Application, 2, 1-19. [https://doi.org/10.1146/annurev-statistics-010814-020127](https://doi.org/10.1146/annurev-statistics-010814-020127) (external link)
