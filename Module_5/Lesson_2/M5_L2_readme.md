    ...
    <tr>
        <td colspan="2">
            <ul>
                ...
                <li><a href="https://www.biorxiv.org/">Biorxiv Preprint</a> (external link) - server for biology</li>
                <li><a href="https://eartharxiv.org/">EarthArXiv</a> (external link)</li>
                <li><a href="https://www.authorea.com/">Authorea</a> (external link)</li>
                <li><a href="https://asapbio.org/preprint-servers">ASAPbio</a> (external link) - catalogs of preprint servers</li>
                <li>and others...</li>
            </ul>
        </td>
    </tr>
...
Evidence for multiple shocks from the γ-ray emission of RS Ophiuchi [Screenshot]. (2023). arXiv. [https://arxiv.org/abs/2211.02059](https://arxiv.org/abs/2211.02059) (external link)
...
Evidence for multiple shocks from the γ-ray emission of RS Ophiuchi [Screenshot]. (2023). IOPscience. [https://iopscience.iop.org/article/10.3847/1538-4357/acc105](https://iopscience.iop.org/article/10.3847/1538-4357/acc105) (external link)
...
<table>
  <thead>
    <tr>
        <th>FOR MATERIAL THAT HAve A DOI &#9745;</th>
...
- Preprint versions of research papers
- Repositories
- Open access papers
...
Which of the following characteristics suggest that a particular paper / data set is more likely to be a credible Open Result?
...
- George, T. (2021). What Are Credible Sources & How to Spot Them. Scribbr. [https://www.scribbr.com/working-with-sources/credible-sources/](https://www.scribbr.com/working-with-sources/credible-sources/) (external link)
...
- JWST Transiting Exoplanet Community Early Release Science Team. Identification of carbon dioxide in an exoplanet atmosphere. Nature 614, 649-652 (2023). [https://doi.org/10.1038/s41586-022-05269-w](https://doi.org/10.1038/s41586-022-05269-w) (external link)
