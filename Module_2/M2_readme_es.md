...
Este módulo está diseñado para ayudarte a comenzar tu camino hacia la práctica de la Ciencia Abierta. Ofrece una visión introductoria de los conceptos y recursos fundamentales de la ciencia. El puente entre los conceptos y su práctica se llama el modelo "usar, hacer, compartir". Hay muchos métodos y modelos que definen cómo empezar con la Ciencia Abierta. El modelo "usar, hacer, compartir" fue creado para ayudarte a asignar de inmediato un propósito a los conceptos y herramientas abordados en este módulo, así como en todo el plan de estudios de Introducción a la Ciencia Abierta. Toda la información que aprendas aquí se abordará con más detalle a medida que participes en otros módulos, pero también puede aplicarse de inmediato después de completar este módulo.

### Objetivos de aprendizaje

-   Definir los elementos fundamentales de la Ciencia Abierta, que incluyen los productos de la investigación, el marco de "usar, hacer, compartir" y el papel de un Plan de Ciencia Abierta y Gestión de Datos.
-   Listar y explicar el propósito de los recursos usados para descubrir y evaluar los productos de investigación para reusarlos incluyendo repositorios, portales de búsqueda, publicaciones, documentación como archivos README (LEEME), metadatos y licencia.
-   Desarrollar una estrategia de alto nivel para crear y compartir datos a partir de los principios FAIR, incorporando un Plan de Gestión de Datos, rastreo de datos y autores con identificadores y citas persistentes, y usados los formatos y herramientas de datos apropiados para generar datos y compartir los resultados.
-   Describir el ciclo de vida del software y diseñar una estrategia de alto nivel para crear y compartir software que considere el uso de un plan de gestión de software, las herramientas necesarias para el desarrollo incluyendo código fuente, núcleos o Kernels, lenguajes de programación, software de terceros, control de versiones, y las herramientas y documentación usadas para publicar y curar Software Abierto.
...
Estos términos clave son temas clave para este módulo. Selecciona el término para ver la descripción.

**Máquina virtual** Un entorno informático que simula la funcionalidad de una máquina física, pero a un nivel de abstracción más alto en una computadora. Esto permite que los recursos de la máquina virtual sean más flexibles y compartimentados.

**Metadata** Información sobre los datos que proporciona detalles adicionales y contexto.

**Repositorio de datos** Una entidad de almacenamiento de datos de una empresa (o, a veces, de entidades u organizaciones) en la que los datos han sido específicamente particionados para un propósito analítico o de reporte.
...
-   [Usar herramientas para la Ciencia Abierta en la práctica](./Lesson_1#usar-herramientas-para-la-ciencia-abierta-en-la-pr%C3%A1ctica)
