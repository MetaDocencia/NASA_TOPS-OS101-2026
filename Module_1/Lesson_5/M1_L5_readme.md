...
<tbody>
    <tr>
        <td>Transparency</td>
        <td>Builds trust in scientific findings but also allows other researchers to validate and build upon them, fostering a culture of openness and cooperation.</td>
    </tr>
    <tr>
        <td>Effective</td>
    ...
    <tr>
        ...
        <td>A key tenet of the scientific method is reproducibility. A well-developed OSDMP helps ensure that others are able to validate your results.</td>
    </tr>
    <tr>
        <td>Preservation</td>
...
Every major research foundation and federal government agency now requires scientists to file a data management plan (DMP) along with their proposed scientific research plan. Some ask for additional details on software/code and publications. Be sure to address all of the funding agencies requirements in your open science strategy.
...
Image credit: Modified by NASA from Unrecognizable chemist taking liquid with pipette from test tube in modern laboratory by RF..studio via [Pexels](https://www.pexels.com/) (external link)
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p><img src="../images/media/image219.jpg" style="width: 100%; height: auto;" /> The JWST Transiting Exoplanet Community Early Release Science Program Publication Policy [Screenshot]. (2023). GitHub. [https://ers-transit.github.io/documents/publication-policy-v1.0.pdf](https://ers-transit.github.io/documents/publication-policy-v1.0.pdf) (external link)</p>
            </td>
        </tr>
    </tbody>
</table>
...
[CLICK TO LEARN (EXTERNAL LINK)](https://opensciency.github.io/sprint-content/open-results/lesson4-opportunities-and-credits.html)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Benefit</td>
            <td>Decreased duplicative efforts, contributors get credit for their work, and accelerated the data wrangling processes</td>
        </tr>
        <tr>
            <td>Result</td>
        ...
        <tr>
            ...
            <td>
                ...
                <p><img src="../images/media/image221.jpg" style="width: 100%; height: auto;" /> Eureka!: An End-to-End Pipeline for JWST Time-Series Observations [Screenshot]. (2023). The Journal of Open Source Software. [https://joss.theoj.org/papers/10.21105/joss.04503](https://joss.theoj.org/papers/10.21105/joss.04503) (external link)</p>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p><img src="../images/media/zenodojwst.jpg" style="width: 100%; height: auto;" /> The JWST Transiting Exoplanet Community Early Release Science Program [Screenshot]. (2023). Zenodo [https://zenodo.org/communities/ers-transit](https://zenodo.org/communities/ers-transit)</p>
            </td>
        </tr>
    </tbody>
</table>
...
OpenSciency on GitHub
[CLICK TO LEARN (EXTERNAL LINK)](https://opensciency.github.io/sprint-content/open-results/lesson2-results-and-open-science.html#what-are-the-advantages-of-making-results-open-throughout-the-research-process)
