  ...
  <tbody>
    <tr>
        <td colspan="2">
            ...
            <ul>
                <li>Does a developer or institution own thecode or software?</li>
            ...
            <p>Find out more about the legal concerns <a href="https://opensource.guide/legal/">Open Source</a> (external link).</p>
        </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr>
        <td colspan="2">
            ...
            <p>Find out more about the security concerns <a href="https://opensciency.github.io/sprint-content/open-software/lesson2-pros-cons.html#security-concerns">OpenSciency</a> (external link).</p>
        </td>
    </tr>
  </tbody>
</table>
...
- Publish the software in a journal dedicated to open software (e.g. JOSS).
...
1. Go to the login page for [GitHub](https://github.com/) and login. If you haven’t already, create a free user account.
...
1.  Navigate to the [Zenodo GitHub page](https://sandbox.zenodo.org/account/settings/github/) and log in to Zenodo.   <img src="../images/media/zenododoi1.jpg" style="width:100%;height:auto" />
2. Click on the button 'Connect' to allow Zenodo to access your GitHub repositories.
3. Review the information about access permissions, then click 'Authorize Zenodo'.
4. Sync your GitHub with Zenodo by clicking 'Sync now' in the upper right corner. <img src="../images/media/zenododoi3.jpg" style="width:100%;height:auto" />
5. To the right of the name of the repository you want to archive ('os-test'), toggle the button to On.
6. Click on the name of the repository.
7. Click the big green button that has 'username/os-test' <img src="../images/media/zenododoi6.jpg" style="width:100%;height:auto" />
8. Add a tag 'test'. You may have to create a new tag for 'test' if prompted.
9. Scroll down and click the green 'publish release' button <img src="../images/media/zenododoi8.jpg" style="width:100%;height:auto" /> Your release should look something like the following: [IMG:]
...
We won't go into these in detail here, but you can check out the Xarray package's GitHub repository (external link) for a good example.
...
**Who will maintain the code (if applicable)?**
...
- Who will help maintain the code
- Who will create the repository and add the necessary files
- Who will become a contributor to the code after it is publicly shared
